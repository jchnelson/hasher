...
private:
    unsigned A = 0xc1059ed8;
    unsigned B = 0x367cd507;
    unsigned C = 0x3070dd17;
    unsigned D = 0xf70e5939;
    unsigned E = 0xffc00b31;
    unsigned F = 0x68581511;
    unsigned G = 0x64f98fa7;
    unsigned H = 0xbefa4fa4;
    unsigned AA = A;
    unsigned BB = B;
    unsigned CC = C;
    unsigned DD = D;
...
unsigned rotr(unsigned, unsigned);
