...
std::string SHA384::hash(unsigned char* message, std::size_t N)
{
    u_ll mblocks[16];
...
std::string SHA384::hash_file(const std::string& filename)
{
...
std::string SHA384::hash_string(const std::string& message)
{
