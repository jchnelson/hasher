...
private:
    u_ll A = 0x6a09e667f3bcc908;
    u_ll B = 0xbb67ae8584caa73b;
    u_ll C = 0x3c6ef372fe94f82b;
    u_ll D = 0xa54ff53a5f1d36f1;
    u_ll E = 0x510e527fade682d1;
    u_ll F = 0x9b05688c2b3e6c1f;
    u_ll G = 0x1f83d9abfb41bd6b;
    u_ll H = 0x5be0cd19137e2179;
    u_ll AA = A;
    u_ll BB = B;
    u_ll CC = C;
    u_ll DD = D;
